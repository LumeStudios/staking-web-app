    ...
    plugins: [
        new webpack.DefinePlugin({
            'process.env': {
                ...
                SERVER: JSON.stringify('https://server-v2.55unity.com'),
                ...
                CONTRACT_ADDRESS_CLAIM: JSON.stringify('0xba2c3b8923f4903cc5ab3c4d3f771c72b46094ac22f014e852c858c145ab89c8')
            }
        })
    ]
});